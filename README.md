...
- **Desktop Application (Tauri)** (Experimental): Run `hmkconf` as a native desktop application. *Note: WebUSB support in Tauri currently requires workarounds due to WebKit/Webview2 limitations.*
